\textbf{Ejercicio:} Calcular el volumen de la región limitada por $x^2 + y^2 = 2ax$, $x^2 + y^2 = az$ y $z = 0$ con $a \in \mathbb{R} \setminus \{0\}$.

Para calcular el volumen de una región sólida $W$, partimos de la definición~\ref{def:vol_solido} y luego aplicamos el Teorema~\ref{teo:cambio_variable} de cambio de variable para integrales triples. Entonces, el volumen del sólido $W$ se expresa como:
