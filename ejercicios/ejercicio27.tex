...
\textbf{Soluci\'on:}
Para calcular el volumen de una región sólida $W$, partimos de la definición~\ref{def:vol_solido} y luego aplicamos el Teorema~\ref{teo:cambio_variable} de cambio de variable para integrales triples. Entonces, el volumen del sólido $W$ se expresa como: \textcolor{red}{Aca si referencian, lo mismo para todos los ejemplos }
...
\begin{figure}[htbp]
    ...
    \input{tikz/Ejemplos/Ejemplo_824.tex} 
    \label{fig:Ejemplo 8.2.4}
\end{figure}
     
Para resolver la integral, se usará el Teorema~\ref{teo:cambio_variable} de cambio de variable para integrales triples. Se usara el cambio de variable famoso, conocido como coordenadas cilindricas. Entonces, la transformacion resulta ser:
