...
\begin{theorem}\label{tayloro2.1} \textbf{Polinimio de Taylor de primer orden.}  Sea $f:U\subseteq\Rn{n}\to\R$  diferenciable. Se define el \emph{polinomio de Taylor de primer orden centrado en $\mathbf{x}_0$ de $f$}, y se nota por $T_1[f,\mathbf{x}_0](\mathbf{x})$, a
  \[
...
\begin{theorem}\label{tayloro2.2} \textbf{Polinimio de Taylor de segundo orden.}  Sea $f:U\subseteq\Rn{n}\to\R$ de clase $\mathcal{C}^2$. Se define el \emph{polinomio de Taylor de segundo orden centrado en $\mathbf{x}_0$ de $f$}, y se nota por $T_2[f,\mathbf{x}_0](\mathbf{x})$, a
  \[
...
\begin{obs}  Para el caso particular de $n=2$,  el polinomio definido en  (\ref{tayloro2.2}), queda:   $$\grad{f}(x_0,y_0) = ( f_x(x_0,y_0), f_y(x_0,y_0)), $$
$$Hf(x_0,y_0) \;=\; 
\begin{bmatrix}
