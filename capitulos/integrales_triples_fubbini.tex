...
\textcolor{red}{Ojo que aca solo enunciaron Fubini para un P, hay que enunciarlo para cualquier conjunto elemental de R3.  Vee como esta en R2 y copiar estructura}


Sea el paralelepípedo $P = [a, b] \times [c, d] \times [e, f]$  y  sea $f: P \to \mathbb{R}$ un campo escalar continuo . Entonces: 
\[
...
\begin{obs} \textcolor{red}{Me da la senasion que hay una mezcla de cosas}
