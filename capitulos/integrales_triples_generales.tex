...
\[
    ...
    \begin{dcases*}
        ...
        0        & si $(x,y,z)\in P\smallsetminus W.$
    \end{dcases*}
\]
...
\begin{propertie}
    Sean $f,\;g$ dos funciones acotadas e integrables en una regi\'on $W\subset\Rn{3}$, entonces:
    \begin{enumerate}
        ...
        \item[iii.]Si existe una constante \(M > 0\) tal que \(\vert{}g(x,y,z)\vert{} \geq M\) \(\forall(x,y,z)\in W\), entonces el cociente \(f/g\) es integrable en \(W\).
