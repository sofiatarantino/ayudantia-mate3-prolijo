...
\begin{solution}
    ...
    \[ 
    0 \leq \left| \frac{\pi(x^{2}-y^{2})}{2\sqrt{x^{2}+y^{2}}} \right| \leq
...
\begin{solution}
    ...
    \begin{equation}
        z= h(1,0) + \grad h(1,0) (x-1,y),  \label{eq:zNabla4}
    ...
    \begin{equation}
        \grad h(1,0)=\grad (f\circ g)(1,0)=\grad f(g(1,0)) \:\boldsymbol{D}_g(1,0) = \grad f (0,0) \:\boldsymbol{D}_g(1,0),  \label{eq:hNabla5}
...
\begin{solution}
    ...
    \begin{equation}
        P_2[f,(0,0)](x,y)=f(0,0)+\grad f(0,0)\cdot(x,y)+\frac{1}{2}(x,y)\boldsymbol{H}_f(0,0)\begin{pmatrix}x\\y\end{pmatrix}, \label{eq:polTay2.3}
    \end{equation}
...
\begin{solution}
    ...
    \begin{enumerate}
    \item $\det(\boldsymbol{H}_f)(-\pi/2,0) = -1 < 0 \implies f$ tiene un punto silla en $(-\pi/2,0)$.
    
    \item $\det(\boldsymbol{H}_f)(\pi/2,0) = 1 > 0 \land f_{xx}(\pi/2,0) = 1 > 0 \implies f$ tiene un mínimo local en $(\pi/2,0)$.
    \end{enumerate}
\end{solution}
