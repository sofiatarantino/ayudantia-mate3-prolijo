...
\textbf{Visualización del sistema de coordenadas polares como en esféricas y cilindricas} \textcolor{red}{Agregar}
...
Primero, dibujemos el \'area pedida   \textcolor{red}{Agregar la misma visualizacion pero con el cambio de dominio correspondiente}
