...
\begin{figure}[htbp]
    ...
    \caption{Puede observarse que el cuadrado $D^*$ en el espacio $(r,\theta)$ se transforma en una corona circular $D$ en el espacio $(x,y)$ bajo la transformaci\'on polares $T$.}
\end{figure}
