...
\begin{figure}[htbp]
    ...
    \input{tikz/Integrales dobles y triples/C_Elemental_tipo1.tex} 
...
\begin{figure}[htbp]
    \centering
    % Llamamos al archivo con el código TikZ extraído
    \input{tikz/Integrales dobles y triples/C_Elemental_tipo2.tex} 
...
\begin{figure}[htbp]
    \centering
    % Llamamos al archivo con el código TikZ extraído
    \input{tikz/Integrales dobles y triples/C_Elemental_tipo3.tex} 
...
\begin{figure}[H]
    \centering
    % Llamamos al archivo con el código TikZ extraído
    \input{tikz/Integrales dobles y triples/Ejemplo_821.tex} 
