\begin{definition} \textbf{Conjunto simplemente  conexo en el plano.} \label{def:conjuntosimpleconexo}
   Sea   $A \subseteq  \mathbb{R}^{2}$ conexo. Decimos que $A$ es un conjunto \emph{simplemente conexo} si toda curva  continua, simple  y  cerrada dentro de \( A \) es la frontera de un conjunto \( A^{*} \) tal que $A^{*}  \subseteq  A$.
   \end{definition}
   \begin{center}
