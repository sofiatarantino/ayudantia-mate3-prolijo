...
\usepackage{pgfplots}%para las figuras tikz en 3D
...
\usepackage{tikz} % ambiente para graficar 
  ...
  \usetikzlibrary{patterns, shapes, 3d, calc}
...
%%%%%%%%%%FORMATOS%%%%%%%%%%
% vector
\newcommand{\vect}[1]{\mathbf{\lowercase{#1}}}
% Matriz
\newcommand{\matriz}[1]{\boldsymbol{\MakeUppercase{#1}}}
% Campo Vectorial
\newcommand{\campoVec}[1]{\mathbf{\MakeUppercase{#1}}}
...
\newtheorem{nota}{Notaci\'on}[section]
