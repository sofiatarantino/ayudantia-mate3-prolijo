    ...
    \addplot3[surf, draw=none,
              point meta=0, colormap={verdedisco1}{color=(green!25) color=(green!25)},
              fill opacity=0.5,
              domain=0:360, y domain=0:2,
              samples=36, samples y=3, shader=interp]
        ({y*cos(x)}, {y*sin(x)}, {0});

    % Superficie lateral
    \addplot3[surf, draw=none,
              point meta=0, colormap={verdelateral}{color=(green!20) color=(green!20)},
              fill opacity=0.42,
              domain=0:360, y domain=0:2.5,
              samples=36, samples y=10, shader=interp]
        ({2*cos(x)}, {2*sin(x)}, {y});

    % Disco superior (z = 2.5)
    \addplot3[surf, draw=none,
              point meta=0, colormap={verdedisco2}{color=(green!35) color=(green!35)},
              fill opacity=0.56,
              domain=0:360, y domain=0:2,
              samples=36, samples y=3, shader=interp]
        ({y*cos(x)}, {y*sin(x)}, {2.5});
