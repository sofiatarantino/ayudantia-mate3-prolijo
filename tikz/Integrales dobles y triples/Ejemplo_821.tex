    ...
    \begin{tikzpicture}[line cap=round, line join=round]
        ...
        % Esfera unitaria x^2 + y^2 + z^2 = 1 (malla liviana para no saturar la superficie)
        \addplot3[
            surf,
            opacity=0.45,
            color=purple!30,
            faceted color=purple!35,
            line width=0.15pt,
            samples=16, % Reducido para que la malla no sature la superficie
            domain=0:360,
            y domain=0:180,
            z buffer=sort
        ]
